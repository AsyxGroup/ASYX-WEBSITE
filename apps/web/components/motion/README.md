...
<section className="relative overflow-hidden">
  ...
  <div className="relative z-10">
    ...
    <h1>
      <TextReveal text="Technology you can rely on" by="word" step={60} />
    </h1>

    <Reveal delay={420}>
      <p>We supply <Typewriter words={["hospitals", "clinics", "institutions"]} /> across Tanzania.</p>
    </Reveal>
...
### `app/smart technology` / `app/services/smart technology` — the process
